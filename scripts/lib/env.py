...
ENV_NAMES = (
    ...
    "MAX_UPLOAD_SIZE_MB", "PASSWORD_MIN_LENGTH", "PASSWORD_MAX_LENGTH", "FORWARDED_ALLOW_IPS",
    "BOOTSTRAP_ADMIN_EMAIL",
    "BOOTSTRAP_ADMIN_USERNAME", "BACKUP_INTERVAL_MINUTES", "BACKUP_RETENTION",
    "VITE_API_URL",
)
ADDED_ENV_NAMES = ("BACKUP_INTERVAL_MINUTES", "BACKUP_RETENTION", "PASSWORD_MIN_LENGTH", "PASSWORD_MAX_LENGTH")
LOCAL_URLS = {
