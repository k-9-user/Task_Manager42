...
function Status()
{
	...
	return (
		<div className="flex min-h-full flex-col gap-6 bg-brand-surface-alt p-8 font-sans max-sm:p-4">
			<h1 className="m-0 text-brand-primary-darker">{t("status.title")}</h1>
			...
			<div className="rounded-xl border border-brand-surface-border bg-brand-surface p-5">
				...
				<ul className="m-0 flex list-none flex-col gap-2 p-0 text-sm text-brand-primary-dark">
			...
			<div className="rounded-xl border border-brand-surface-border bg-brand-surface p-5 text-sm text-brand-primary-dark">
