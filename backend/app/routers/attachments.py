...
@router.get(
    "/api/tasks/{task_id}/banner/file",
    summary="Download a task banner image",
    description=(
        "Serve a task's banner image to any project member. Uploads are not "
        "exposed as unrestricted static content; every download rechecks "
        "current project membership."
    ),
    responses={
        status.HTTP_404_NOT_FOUND: {
            "description": "Task, banner or project membership not found.",
        },
    },
)
